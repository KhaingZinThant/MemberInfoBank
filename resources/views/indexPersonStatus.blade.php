...
<div class="container">
    <h1><center>Person Status List Data</center></h1><br>
    <div class="pull-right">
   <a class="btn btn-success" href="{{route('personStatusCN.create')}}" > Print</a>
     <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct">Add New PersonStatus</a>
  </div>
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   <input type="hidden" name="statusId" id="statusId">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="statusDesc" placeholder="Enter Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                    <!--  <div class="form-group">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('personStatusCN.index') }}",
        columns: [
    ...
    $('body').on('click', '.editProduct', function () {
      ...
      $.get("{{ route('personStatusCN.index') }}" +'/' + product_id +'/edit', function (data) {
          $('#modelHeading').html("Edit Product");
          $('#saveBtn').val("edit-user");
          $('#ajaxModel').modal('show');
          $('#statusId').val(data.statusId);
          $('#name').val(data.statusDesc);
    ...
    $('#saveBtn').click(function (e) {
        ...
        $.ajax({
          ...
          url: "{{ route('personStatusCN.store') }}",
          type: "POST",
          dataType: 'json',
    ...
    $('body').on('click', '.deleteProduct', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('personStatusCN.store') }}"+'/'+product_id,
