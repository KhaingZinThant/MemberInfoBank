...
<div class="container">
  <h1><center>Room List Data</center></h1><br>
    ...
    <a class="btn btn-success" href="{{route('roomCN.create')}}" > Print </a>
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   <input type="hidden" name="roomId" id="roomId">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="roomDesc" placeholder="Enter Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                     <div class="form-group">
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editProduct', function () {
      ...
      $.get("{{ route('roomCN.index') }}" +'/' + product_id +'/edit', function (data) {
          $('#modelHeading').html("Edit Product");
          $('#saveBtn').val("edit-user");
          $('#ajaxModel').modal('show');
          $('#roomId').val(data.roomId);
          $('#name').val(data.roomDesc);
   ...
   $('body').on('click', '.deleteProduct', function () {
       ...
       $('#ok_button').text('Delete');
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('roomCN.store') }}"+'/'+product_id,
              beforeSend:function(){
